...
def rle_in(text="text_words.txt", code_text="text_code_words.txt"):
...
rle_in(input("Enter the name of the file with the text: "), input("Enter the file name to record: "))
rle_dec(input("Enter the name of the file to decode: "))
